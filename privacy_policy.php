...
<li class="nav-item">
            ...
            <div class="textNav">
                <div class="container tab-space textContainer">

                    <h3>Informativa sulla Privacy</h3>
                    <p>Data di entrata in vigore: April 25, 2021</p>

                    <hr class="margin25" />

                    <h5 class="bold">Titolare del Trattamento dei Dati</h5>
                    <p>
                        Mati<br />
                    via Pizzo Camino, 2<br />
                    24060 Chiuduno (BG)<br />
                    P.IVA 04396620165<br />
                    Indirizzo e-mail: <a href="mailto: info@mati-gasket.it">info@mati-gasket.it</a>
                    </p>

                    <p>Come da regolamento (UE) 2016/679 (GDPR) in vigore dal 24 Maggio 2016 la società
                <i>Mati</i> si occupa del trattamento dei dati relativi
                al sito www.mati-gasket.it/.</p>
                    ...
                    <p>Utilizziamo i vostri dati per fornire e migliorare il Servizio. Utilizzando il Servizio, accettate la raccolta e l'utilizzo delle informazioni in conformità con questa informativa.
                    ...
                    Tali dati sono conservati in una forma che consenta l‘identificazione dell‘interessato per un periodo di
                    tempo non superiore a quello necessario agli scopi per i quali essi sono stati raccolti o
                successivamente trattati.</p>

                    <hr class="margin25" />

                    <h5 class="bold">Tipologie di Dati raccolti</h5>
                ...
                personali"). Le informazioni di identificazione personale possono includere, ma non sono limitate a:</p>
                    ...
                    <ul>
                        ...
                        <li>Indirizzo</li>
                        <li>Lingua utilizzata</li>
                        <li>Cookie e dati di utilizzo</li>
                    </ul>

                    <h6>Dati di utilizzo</h6>

                    <p>Raccogliamo informazioni su come l'utente accede e utilizza il Servizio ("Dati di utilizzo").
                    Questi Dati di utilizzo possono includere informazioni quali:
                </p>
                    <ul>
                        <li>indirizzo IP</li>
                        <li>il tipo e versione di browser</li>
                        <li>le pagine del nostro servizio visitate</li>
                        <li>l'ora e la data della visita</li>
                        <li>il tempo trascorso su tali pagine</li>
                        <li>identificatore unico del dispositivo e altri dati diagnostici.</li>
                    </ul>

                    <p>I Dati Personali possono essere liberamente forniti dall'Utente o, nel caso di Dati di Utilizzo,
                    raccolti automaticamente durante l'uso di www.mati-gasket.it/.
                    Se non diversamente specificato, tutti i Dati richiesti da www.mati-gasket.it/ sono
                    obbligatori. Se l’Utente rifiuta di comunicarli, potrebbe essere impossibile per
                    www.mati-gasket.it/ fornire il Servizio. Nei casi in cui www.mati-gasket.it/
                    indichi alcuni Dati come facoltativi, gli Utenti sono liberi di astenersi dal comunicare tali Dati,
                ...
                L’eventuale utilizzo di Cookie - o di altri strumenti di tracciamento - da parte di
                www.mati-gasket.it/ o dei titolari dei servizi terzi utilizzati da
                www.mati-gasket.it/, ove non diversamente precisato, ha la finalità di fornire il Servizio
                ...
                mediante www.mati-gasket.it/ e garantisce di avere il diritto di comunicarli o diffonderli,
                liberando il Titolare da qualsiasi responsabilità verso terzi.
                </p>

                    <hr class="margin25" />

                    <h5 class="bold">Modalità e luogo del trattamento dei Dati raccolti</h5>
                    <br />
                    <h6 class="bold">Modalità di trattamento</h6>
                    <p>Il Titolare adotta le opportune misure di sicurezza volte ad impedire l’accesso, la divulgazione,
                la modifica o la distruzione non autorizzate dei Dati Personali. <br />
                ...
                casi, potrebbero avere accesso ai Dati altri soggetti coinvolti nell’organizzazione di www.mati-gasket.it/
                ...
                parte del Titolare. L’elenco aggiornato dei Responsabili potrà sempre essere richiesto
                al Titolare del Trattamento.</p>

                    <br />
                    <h6 class="bold">Base giuridica del trattamento</h6>
                    <p>Il Titolare tratta Dati Personali relativi all’Utente in caso sussista una delle seguenti condizioni:

                    l’Utente ha prestato il consenso per una o più finalità specifiche; Nota: in alcuni ordinamenti il
                    ...
                    il trattamento è necessario all'esecuzione di un contratto con l’Utente e/o all'esecuzione di misure
                    precontrattuali;
                ...
                contratto o necessario per concludere un contratto.</p>
                    ...
                    <p>L’Utente può verificare se abbia luogo uno dei trasferimenti appena descritti esaminando la sezione di
                    ...
                    <br />
                    <h6 class="bold">Periodo di conservazione</h6>
                    <p>
                ...
                Pertanto:
                    ...
                    <ul>
                        ...
                        <li>I Dati Personali raccolti per finalità riconducibili all’interesse legittimo del Titolare
                    ...
                    <p>
                        ...
                        a lungo sino a quando detto consenso non venga revocato. Inoltre, il Titolare potrebbe essere obbligato
                        a conservare i Dati Personali per un periodo più lungo in ottemperanza ad un obbligo di legge o per
                    ...
                    <h5 class="bold">Finalità del Trattamento dei Dati raccolti</h5>
                    <p>
                        I Dati dell’Utente sono raccolti per consentire al Titolare di fornire i propri Servizi, così come per le seguenti finalità: Visualizzazione di contenuti da piattaforme esterne, Statistica, Gestione contatti e invio di messaggi, Contattare l'Utente, Gestione dei pagamenti e Remarketing e behavioral targeting.
                </p>

                    <p>
                        Per ottenere ulteriori informazioni dettagliate sulle finalità del trattamento e sui Dati Personali
                    ...
                    <br />
                    <h5 class="bold">Dettagli sul Trattamento dei Dati raccolti</h5>
                    <p>
                        I Dati Personali sono raccolti per le seguenti finalità ed utilizzando i seguenti servizi:
                </p>
                    <ul>
                        <li>
                            <h6 class="bold">Contattare l'Utente</h6>
                        Modulo di contatto (www.mati-gasket.it/)<br />
                            <p> L’Utente, compilando con i propri Dati il modulo di contatto, acconsente al loro utilizzo per rispondere alle richieste di informazioni, di preventivo, o di qualunque altra natura indicata dall’intestazione del modulo.</p>

                            <p>Dati Personali raccolti: nome; cognome; email; indirizzo; posizione.</p>
                        </li>
                        <br />
                        <li>
                            <h6 class="bold">Gestione dei pagamenti</h6>
                            <p>I servizi di gestione dei pagamenti permettono a www.mati-gasket.it/ di processare pagamenti tramite carta di credito o altri strumenti. I dati utilizzati per il pagamento vengono acquisiti direttamente dal gestore del servizio di pagamento richiesto senza essere in alcun modo trattati da www.mati-gasket.it/. <br />
                       Alcuni di questi servizi potrebbero inoltre permettere l'invio programmato di messaggi all'Utente, come email contenenti fatture o notifiche riguardanti il pagamento.</p>
                            ...
                            <span class="bold">Stripe</span>
                        <p>Stripe è un servizio di pagamento fornito da Stripe, Inc, che consente all’Utente di effettuare pagamenti online.<br/>
                        Dati Personali raccolti: varie tipologie di Dati secondo quanto specificato dalla privacy policy del servizio.
                        <br/>
                        Luogo del trattamento: Consulta la privacy policy di Stripe - <a href="https://stripe.com/en-IT/privacy" target="_blank" rel="noopener noreferrer"> Privacy Policy</a> </p>
                    */ }
                        </li>

                        <br />
                        <li>
                            <h6 class="bold">Visualizzazione di contenuti da piattaforme esterne</h6>
                            <p>Questo tipo di servizi permette di visualizzare contenuti ospitati su piattaforme esterne
                            direttamente dalle pagine di www.mati-gasket.it/ e di interagire con essi.<br />
                            Nel caso in cui sia installato un servizio di questo tipo, è possibile che, anche nel caso gli Utenti non utilizzino il servizio, lo stesso raccolga dati di traffico relativi alle pagine in cui è installato.</p>

                            <span class="bold">Google Fonts (Google LLC)</span>
                            <p>Google Fonts è un servizio di visualizzazione di stili di carattere gestito da Google LLC che permette a www.mati-gasket.it/ di integrare tali contenuti all’interno delle proprie pagine.<br />
                            Dati Personali raccolti: varie tipologie di Dati secondo quanto specificato dalla privacy policy del servizio.</p>
                            <p>
                                Luogo del trattamento: Stati Uniti – <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer"> Privacy Policy</a><br />
                            Soggetto aderente al Privacy Shield.</p>
                        </li>

                        <br />
                        <li>
                            <h6 class="bold">Statistica</h6>
                            <p>I servizi contenuti nella presente sezione permettono al Titolare del Trattamento di monitorare e
                            analizzare i dati di traffico e servono a tener traccia del comportamento dell’Utente.</p>

                            <span class="bold">Google Analytics (Google LLC)</span>
                            <p>Google Analytics è un servizio di analisi web fornito da Google LLC (“Google”). Google
                            utilizza i Dati Personali raccolti allo scopo di tracciare ed esaminare l’utilizzo di
                            www.mati-gasket.it/, compilare report e condividerli con gli altri servizi sviluppati da Google.
                            Google potrebbe utilizzare i Dati Personali per contestualizzare e personalizzare gli annunci
                            del proprio network pubblicitario.</p>
                            <p>Dati Personali raccolti: Cookie; Dati di utilizzo.<br />
                            Luogo del trattamento: Stati Uniti – <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer"> Privacy Policy</a> <br />
                            Per la disattivazione del servizio sul proprio browser: <a href="https://tools.google.com/dlpage/gaoptout?hl=it" target="_blank" rel="noopener noreferrer"> Opt Out.</a><br />
                            Soggetto aderente al Privacy Shield.</p>
                        </li>
                    ...
                    <h5 class="bold">Ulteriori informazioni sui Dati Personali</h5>
                    <p>
                        I Dati Personali raccolti sono utilizzati per l’erogazione di servizi all’Utente o per la vendita di prodotti, inclusi il pagamento e l’eventuale consegna. I Dati Personali raccolti per perfezionare il pagamento possono essere quelli relativi alla carta di credito, al conto corrente utilizzato per il bonifico o ad altri strumenti di pagamento previsti. I Dati di pagamento raccolti da www.mati-gasket.it/ dipendono dal sistema di pagamento utilizzato.
                    </p>
                    <h6 class="bold">Link ad altri siti</h6>
                    ...
                    <br />
                    <h6 class="bold">Privacy dei minori</h6>
                    <p>Il nostro servizio non si rivolge a minori di 18 anni ("Bambini").<br />
                    Non raccogliamo consapevolmente informazioni personali relative a utenti di età inferiore a 18 anni. Se
                    siete un genitore o tutore e siete consapevoli che vostro figlio ci ha fornito Dati personali, vi
                    preghiamo di contattarci. Se veniamo a conoscenza del fatto che abbiamo raccolto Dati personali da
                    minori senza la verifica del consenso dei genitori, adotteremo provvedimenti per rimuovere tali
                    informazioni dai nostri server.</p>


                    <hr class="margin25" />

                    <h5 class="bold">Diritti dell'Utente</h5>
                    ...
                    <h6 class="bold">Dettagli sul diritto di opposizione</h6>
                    ...
                    <h6 class="bold">Come esercitare i diritti</h6>
                    <p>Per esercitare i diritti dell’Utente, gli Utenti possono indirizzare una richiesta agli estremi di contatto del Titolare indicati in questo documento. Le richieste sono depositate a titolo gratuito e evase dal Titolare nel più breve tempo possibile, in ogni caso entro un mese.</p>

                    <hr class="margin25" />

                    <h5 class="bold">Cookie Policy</h5>

                    <p>www.mati-gasket.it/ fa utilizzo di Cookie. Per saperne di più e per prendere visione dell’informativa dettagliata, l’Utente può consultare la <a href="cookie" target="_blank" rel="noopener noreferrer">Cookie Policy</a></p>

                    <hr class="margin25" />

                    <h5 class="bold">Ulteriori informazioni sul trattamento</h5>
                    <h6 class="bold">Difesa in giudizio</h6>
                    <p>I Dati Personali dell’Utente possono essere utilizzati da parte del Titolare in giudizio o nelle fasi
                    preparatorie alla sua eventuale instaurazione per la difesa da abusi nell'utilizzo di www.mati-gasket.it/
                    ...
                    <h6 class="bold">Informative specifiche</h6>
                    <p>Su richiesta dell’Utente, in aggiunta alle informazioni contenute in questa privacy policy, www.mati-gasket.it/ potrebbe fornire all'Utente delle informative aggiuntive e contestuali riguardanti Servizi specifici, o la raccolta ed il trattamento di Dati Personali.</p>

                    <h6 class="bold">Log di sistema e manutenzione</h6>
                    <p>Per necessità legate al funzionamento ed alla manutenzione, www.mati-gasket.it/ e gli eventuali servizi terzi da essa utilizzati potrebbero raccogliere log di sistema, ossia file che registrano le interazioni e che possono contenere anche Dati Personali, quali l’indirizzo IP Utente.</p>

                    <h6 class="bold">Informazioni non contenute in questa policy</h6>
                    <p>Ulteriori informazioni in relazione al trattamento dei Dati Personali potranno essere richieste in qualsiasi momento al Titolare del Trattamento utilizzando gli estremi di contatto.</p>

                    <h6 class="bold">Risposta alle richieste "Do Not Track"</h6>
                    <p>www.mati-gasket.it/ non supporta le richieste “Do Not Track”.<br />
                    ...
                    <h6 class="bold">Modifiche a questa privacy policy</h6>
                    <p>Il Titolare del Trattamento si riserva il diritto di apportare modifiche alla presente privacy policy
                    in qualunque momento dandone informazione agli Utenti su questa pagina e, se possibile, su
                    www.mati-gasket.it/ nonché, qualora tecnicamente e legalmente fattibile, inviando una notifica agli Utenti
                    attraverso uno degli estremi di contatto di cui è in possesso il Titolare . Si prega dunque di
                    consultare regolarmente questa pagina, facendo riferimento alla data di ultima modifica
                    indicata in fondo.
                    <br />
                    Qualora le modifiche interessino trattamenti la cui base giuridica è il consenso, il Titolare provvederà
                    a raccogliere nuovamente il consenso dell’Utente, se necessario.</p>
